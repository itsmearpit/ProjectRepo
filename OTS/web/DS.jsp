<%-- 
    Document   : DS
    Created on : 8 May, 2019, 12:20:41 PM
    Author     : Awesome
--%>
...
<head>
    ...
    <title>BrainStormer.com|Data Structure & Algorithm Online Tests</title>
    <meta charset="utf-8">
  ...
  <title>DS & Algo Online Tests  DS & Algo Mock Tests  </title>
  ...
  <body>
    ...
    <div class="main_container">
      ...
      <h1 class="page_title">Data Structure & Algorithm Online Tests</h1>
    </div>
    ...
    <div class="container ">
      ...
      <h2 class="header_title"><i class="fa fa-cubes margin-r-5 text-primary"></i> DS & Algo Test Series</h2>
      ...
      <%
        ...
        try 
        {
            ...
            String sq = "select TestID,TestName,Sub,QSecA,QSecB,QSecC,TimeA,TimeB,TimeC from test where Sub='DS';";
