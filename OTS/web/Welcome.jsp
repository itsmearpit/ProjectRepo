<%-- 
    Document   : Welcome
    Created on : 24 Mar, 2019, 10:14:02 PM
    Author     : Awesome
--%>
...
<html>
    <head>
        <title>BrainStormer.com|Welcome Page</title>
        <meta charset="UTF-8">
                  ...
                  <div class="modal-body clearfix">
                    <div class="col-md-12 clearfix position-initial">
                          ...
                          <div class="clearfix">       
                              ...
                              <form method="post" action="https://testpot.com/accounts/register/" class="form-horizontal signup_form_ajax position-initial" role="form">
                                ...
                                <input type="hidden" name="user_type" value="">
                                <div class="form-group">
                                  <label for="registration_account_type" class="  col-sm-3 control-label">Account Type</label>
                                  <div class="col-sm-7">
                                    <select class="form-control" name="account_type" id="registration_account_type">
                                      <option value="candidate">Candidate</option>
                                      <option value="teacher">Teacher at a College/School</option>
