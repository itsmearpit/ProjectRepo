...
<head>
    ...
    <title>BrainStormer.com|Operating System Online Tests</title>
    <meta charset="utf-8">
  ...
  <title>OS Online Tests  OS Mock Tests  </title>
  ...
  <style>
    ...
    <script>
        function msg(id,email)
        {
            ...
            {
                window.location= "Ques.jsp?tid="+id+"&qid=1&flag=0&min=<%=min%>&second=<%=scnd%>";
            }
        }
    </script>
  ...
  <body>
    ...
    <div class="main_container">
      ...
      <h1 class="page_title">Operating System Online Tests</h1>
    </div>
    ...
    <div class="container ">
      ...
      <h2 class="header_title"><i class="fa fa-cubes margin-r-5 text-primary"></i> OS Test Series</h2>
      ...
      <%
        ...
        try 
        {
            ...
            String sq = "select TestID,TestName,Sub,QSecA,QSecB,QSecC,TimeA,TimeB,TimeC from test where Sub='OS';";
            ...
            while(r1.next())
            {
                ...
                TB=r1.getString(8);
                TC=r1.getString(9);
                tt=((Integer.parseInt(TA)+Integer.parseInt(TB)+Integer.parseInt(TC))*60)/(QA+QB+QC);
                min=tt/60;
                scnd=tt%60;
            %>
