<%-- 
    Document   : login
    Created on : 13 Mar, 2019, 9:17:56 AM
    Author     : Awesome
--%>
...
<!-- Mirrored from testpot.com/accounts/login/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Jan 2019 08:38:28 GMT -->
<!-- Added by HTTrack --><!--<meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>

  
    <!-- Required meta tags always come first -->
    <title>BrainStormer.com|Login Page</title>
    <meta charset="utf-8">
...
<div class="main_container margin-t-100">
  <div class="col-sm-6 col-sm-offset-3">
    ...
    <div class="box box-solid">
      <div class="box-header bg-gray">
        <h3 class="box-title display-block text-center"><strong> Login </strong></h3>
      </div>
        ...
        <div class="clearfix ">
          ...
          <form method="post" action="log.jsp" class="form-horizontal" role="form">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <input type="email" name="username" class="form-control" id="reg_login_email" placeholder="you@example.com">
                <div class="help-text"></div>
              </div>
            </div>
            <div class="form-group margin-bottom-">
              <label for="reg_login_password" class="  col-sm-3 control-label">Password</label>
              <div class="col-sm-7">
                <input type="password" name="password" class="form-control" id="reg_login_password" placeholder="Password">
                <div class="help-text"></div>
              </div>
            </div>
            ...
            <div class="form-group">
              <div class="col-sm-offset-3 col-sm-7">
                <button type="submit" id="reg_login_btn" class="btn btn-success btn-block">Sign in</button>
              </div>
            </div>
          </form>
          <p class="text-center col-sm-10 col-sm-offset-1"><a href="Register.html">New User ?  Register Here</a></p>
