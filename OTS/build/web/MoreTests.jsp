...
<head>
    ...
    <title>BrainStormer.com|Miscellaneous Tests</title>
    <meta charset="utf-8">
  ...
  <title>Miscellaneous Online Tests  Miscellaneous Mock Tests  </title>
  ...
  <body>
    ...
    <div class="main_container">
      ...
      <div class="inner_page_header" style="background-image:url(images/intro_bg_inner.jpg)">
      	<h1 class="page_title">Miscellaneous Online Tests</h1>
      </div>
    <div class="container ">
      ...
      <h2 class="header_title"><i class="fa fa-cubes margin-r-5 text-primary"></i> <a href="#">Aptitude Speed Tests</a></h2>
      ...
      <%
        ...
        try 
        {
            ...
            String sq = "select TestID,TestName,Sub,QSecA,QSecB,QSecC,TimeA,TimeB,TimeC from test where Sub='AP';";
          ...
          <div class="col-sm-3 col-md-2 col-xs-12col-md-2 margin-b-10">
            ...
            <div class="info-box ribbon_box">
              ...
              <div class="info">
                <div class="img">
                    <img src="images/Aptitude.png" alt="A"/>
